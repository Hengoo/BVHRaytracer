...
\begin{figure}[!htb]
	\begin{minipage}[t]{0.4\textwidth}
		...
		\begin{tikzpicture}
			\begin{axis}
			[
			ylabel = leafIntersections,
			xlabel = branching factor,
			colormap = {blue}{rgb = (1,0,0), rgb = (0,0,1)},
			]
			\addplot[contour filled={number=18, labels = {false}}, thick, color = red] table[x = branchFactor, y = leafIntersections, col sep=comma] {Data/sponzaTable.txt};
			\end{axis}
		\end{tikzpicture}
	...
	\begin{minipage}[t]{0.4\textwidth}
		...
		\begin{tikzpicture}
			\begin{axis}
				[
				ylabel = nodeIntersections,
				xlabel = branching factor,
				colormap = {blue}{rgb = (1,0,0), rgb = (0,0,1)},
				]
				
				\addplot[contour filled={number=8, labels = {false}}, thick] table[x = branchFactor, y = nodeIntersections, col sep=comma] {Data/sponzaTable.txt};
...
\begin{figure}[!htb]
	\begin{minipage}[t]{0.4\textwidth}
		...
		\addplot[contour filled={number=18, labels = {false}}, thick, color = red] table[x = leafSize, y = leafIntersections, col sep=comma] {Data/sponzaTable.txt};
		\end{axis}
		\end{tikzpicture}
	...
	\begin{minipage}[t]{0.4\textwidth}
		...
		\addplot[contour filled={number=8, labels = {false}}, thick] table[x = leafSize, y = nodeIntersections, col sep=comma] {Data/sponzaTable.txt};
