...
\begin{figure}[!htb]
	\begin{minipage}[t]{0.4\textwidth} 
		...
		\addplot[scatter,mark=*, only marks,point meta=\thisrow{leafIntersections}, draw opacity=0 ,mark=square*] table[x = leafSize, y = branchFactor, col sep=comma]
		{Data/shiftHappensTable.txt};
		\end{axis}
		\end{tikzpicture}
	...
	\begin{minipage}[t]{0.4\textwidth}
		...
		\addplot[scatter,mark=*, only marks,point meta=\thisrow{nodeIntersections}, draw opacity=0 ,mark=square*] table[x = leafSize, y = branchFactor, col sep=comma]
		{Data/shiftHappensTable.txt};
		\end{axis}
		\end{tikzpicture}
	\end{minipage}
	...
	\begin{minipage}[t]{0.4\textwidth} 
		...
		\addplot[scatter,mark=*, only marks,point meta=\thisrow{shadowLeafIntersections}, draw opacity=0 ,mark=square*] table[x = leafSize, y = branchFactor, col sep=comma]
		{Data/shiftHappensTable.txt};
		\end{axis}
		\end{tikzpicture}
	...
	\begin{minipage}[t]{0.4\textwidth}
		...
		\addplot[scatter,mark=*, only marks,point meta=\thisrow{shadowNodeIntersections}, draw opacity=0 ,mark=square*] table[x = leafSize, y = branchFactor, col sep=comma]
		{Data/shiftHappensTable.txt};
		\end{axis}
		\end{tikzpicture}
	\end{minipage}
\caption{Shift happens. Low poly scene. 53,857 Vertices and 240,865 Triangles }
\end{figure}
...
\begin{figure}[!htb]
	...
	\begin{minipage}[t]{0.4\textwidth}
		...
		\end{tikzpicture}
	\end{minipage}
\caption{Sponza. Interior scene. 192,676 Vertices and 262,267 Triangles }
\end{figure}
...
%		ylabel = branching factpr,
	...
	\begin{minipage}[t]{0.4\textwidth}
		...
		\end{tikzpicture}
	\end{minipage}
	\caption{Rungholt. Large minecraft city. 11,630,990 Vertices and 16959,775 Triangles}
\end{figure}
...
\begin{figure}[!htb]
	...
	\begin{minipage}[t]{0.4\textwidth}
		...
		\end{tikzpicture}
	\end{minipage}
	\caption{Eratio. Scan of a marmor statue. 235,332 Vertices and 412,669 Triangles }
\end{figure}
...
\begin{figure}[!htb]
	...
	\begin{minipage}[t]{0.4\textwidth}
		...
		\end{tikzpicture}
	\end{minipage}
	\caption{Average of all results}
\end{figure}
