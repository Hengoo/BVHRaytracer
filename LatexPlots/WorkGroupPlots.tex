...
\begin{minipage}[t]{1.1\textwidth}
	...
	%view={90}{0} for x, view={0}{0} for y restriction
	view={0}{0},
	xlabel = N4L4 combined intersections,
	%	ylabel = standard deviation,
	smooth,
	...
	\addplot+ [color = black, thick] table[x = id, y = median, col sep=comma]{Data/amazonLumberyardInterior_b4_l4_CombinedWorkGroupWiskerPlot.txt};
	\addplot+ [color = blue, opacity = 0.3, name path=test1] table[x = id, y = lowerStdDeviation, col sep=comma]{Data/amazonLumberyardInterior_b4_l4_CombinedWorkGroupWiskerPlot.txt};
	\addplot+ [color = blue, opacity = 0.3, name path=test2] table[x = id, y = upperStdDeviation, col sep=comma]{Data/amazonLumberyardInterior_b4_l4_CombinedWorkGroupWiskerPlot.txt};
	\addplot+ [color = black, opacity = 0.5] table[x = id, y = min, col sep=comma]{Data/amazonLumberyardInterior_b4_l4_CombinedWorkGroupWiskerPlot.txt};
	\addplot+ [color = black, opacity = 0.5] table[x = id, y = max, col sep=comma]{Data/amazonLumberyardInterior_b4_l4_CombinedWorkGroupWiskerPlot.txt};
...
\begin{minipage}[t]{1.1\textwidth}
	...
	%view={90}{0} for x, view={0}{0} for y restriction
	view={0}{0},
	xlabel = N8L8 combined intersections,
	%	ylabel = standard deviation,
	smooth,
	enlarge x limits=false,
	xmajorticks=false,
	...
	\addplot+ [color = black, thick] table[x = id, y = median, col sep=comma]{Data/amazonLumberyardInterior_b8_l8_CombinedWorkGroupWiskerPlot.txt};
	\addplot+ [color = blue, opacity = 0.3, name path=test1] table[x = id, y = lowerStdDeviation, col sep=comma]{Data/amazonLumberyardInterior_b8_l8_CombinedWorkGroupWiskerPlot.txt};
	\addplot+ [color = blue, opacity = 0.3, name path=test2] table[x = id, y = upperStdDeviation, col sep=comma]{Data/amazonLumberyardInterior_b8_l8_CombinedWorkGroupWiskerPlot.txt};
	\addplot+ [color = black, opacity = 0.5] table[x = id, y = min, col sep=comma]{Data/amazonLumberyardInterior_b8_l8_CombinedWorkGroupWiskerPlot.txt};
	\addplot+ [color = black, opacity = 0.5] table[x = id, y = max, col sep=comma]{Data/amazonLumberyardInterior_b8_l8_CombinedWorkGroupWiskerPlot.txt};
